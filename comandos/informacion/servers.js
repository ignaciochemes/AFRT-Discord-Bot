...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        await find('port', 9623)
            .then(function (list) {
                if (!list.length) {
                    server2 = `${carpetas[8]} = \`OFF\``;
                } else {
                    server2 = `${carpetas[8]} = \`ON\` Con un ping de: \`${Math.floor(res.avg)}\` MS`;
                }
            });
        await find('port', 9624)
            .then(function (list) {
                if (!list.length) {
                    server3 = `${carpetas[9]} = \`OFF\``;
                } else {
                    server3 = `${carpetas[9]} = \`ON\` Con un ping de: \`${Math.floor(res.avg)}\` MS`;
                }
            });
        await find('port', 9625)
            .then(function (list) {
                if (!list.length) {
                    server4 = `${carpetas[10]} = \`OFF\``;
                } else {
                    server4 = `${carpetas[10]} = \`ON\` Con un ping de: \`${Math.floor(res.avg)}\` MS`;
                }
            });
        await find('port', 9626)
            .then(function (list) {
                if (!list.length) {
                    server5 = `${carpetas[11]} = \`OFF\``;
                } else {
                    server5 = `${carpetas[11]} = \`ON\` Con un ping de: \`${Math.floor(res.avg)}\` MS`;
                }
            });
        await find('port', 9627)
            .then(function (list) {
                if (!list.length) {
                    server6 = `${carpetas[12]} = \`OFF\``;
                } else {
                    server6 = `${carpetas[12]} = \`ON\` Con un ping de: \`${Math.floor(res.avg)}\` MS`;
                }
            });
        await find('port', 9628)
            .then(function (list) {
                if (!list.length) {
                    server7 = `${carpetas[13]} = \`OFF\``;
                } else {
                    server7 = `${carpetas[13]} = \`ON\` Con un ping de: \`${Math.floor(res.avg)}\` MS`;
                }
            });
        await find('port', 9629)
            .then(function (list) {
                if (!list.length) {
                    server8 = `${carpetas[14]} = \`OFF\``;
                } else {
                    server8 = `${carpetas[14]} = \`ON\` Con un ping de: \`${Math.floor(res.avg)}\` MS`;
                }
            });
        await find('port', 9630)
            .then(function (list) {
                if (!list.length) {
                    server9 = `${carpetas[15]} = \`OFF\``;
                } else {
                    server9 = `${carpetas[15]} = \`ON\` Con un ping de: \`${Math.floor(res.avg)}\` MS`;
                }
            });
        await find('port', 9631)
            .then(function (list) {
                if (!list.length) {
                    server10 = `${carpetas[8]} = \`OFF\``;
                } else {
                    server10 = `${carpetas[8]} = \`ON\` Con un ping de: \`${Math.floor(res.avg)}\` MS`;
                }
            });
